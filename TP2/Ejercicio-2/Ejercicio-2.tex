...
\centering
	...
	\caption{Comparación de la transformada de fourier de la estimación de la función de autocorrelación y la calculada.}
...
\centering
	...
	\caption{Promediacion de periodigramas.}
	\label{fig:fft-calc}
\end{figure}
