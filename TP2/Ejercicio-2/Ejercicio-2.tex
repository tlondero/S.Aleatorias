...
\end{gathered}
\end{equation*}
siendo $N$ el tamaño de $X(n)$, y $k = 0, 1, ... \ , 127$.

Mediante el uso de estos, se normaliza para poder obtener los coeficientes de autocorrelación $r_{XXp}$ y $r_{XXnp}$. 
...
En la Figura (\ref{fig:phikk}), a diferencia de la anterior, se obtuvo una mayor diferencia entre ambas curvas \textcolor{red}{ACÁ SE PODRÍA PONER ALGO A MODO DE REFLEXIÓN, DE PORQUÉ PASA ESTO O DE QUE SIGNIFICA, QUE SE YO AUXILIO.}
