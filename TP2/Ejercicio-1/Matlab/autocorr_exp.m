function [ exp_autocorr ] = autocorr_exp( functions, fun_quant,t1, t2)
...
exp_autocorr = 0;   %inicializo en 0

for i=1:fun_quant 
    exp_autocorr = exp_autocorr + (1/fun_quant)*(functions{i}(t1))*(functions{i}(t2));
end
